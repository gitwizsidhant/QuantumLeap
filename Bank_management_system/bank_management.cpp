/*
This program is a simple bank management system. It allows users to open an account, deposit money, withdraw money, display a single account, or display all accounts.

The program uses a class called `Bank` to represent a bank account. Each bank account has the following properties:
...
The program also has a function called `generateAccountNumber()` which generates a unique account number for each new account.

The main function of the program is a loop that allows the user to choose from a menu of options. The options are:

1. Open account
2. Deposit money
3. Withdraw money
4. Display single account
5. Display all accounts
6. Exit

The program validates the user's input and takes appropriate action for each option.
*/
#include <iostream>
#include <string>
#include <limits>
